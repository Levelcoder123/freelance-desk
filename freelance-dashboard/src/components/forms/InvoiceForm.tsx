...
import { Invoice, Client, InvoiceLineItem } from '../../types'
...
const emptyItem = (): InvoiceLineItem => ({ description: '', quantity: 1, rate: 0, amount: 0 })
...
export default function InvoiceForm({ initial = null, onSubmit, loading }: InvoiceFormProps) {
