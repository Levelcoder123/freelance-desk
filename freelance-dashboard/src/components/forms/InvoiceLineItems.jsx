...
export function InvoiceLineItems({ items, onSetItem, onAddItem, onRemoveItem, subtotal }) {
  const colStyle = {
    fontSize: 11,
    fontWeight: 600,
            ...
            <tr key={i} style={{ borderTop: '1px solid var(--border)' }}>
              ...
              <td>
                <input
                  ...
                  value={item.quantity}
                  onChange={e => onSetItem(i, 'quantity', e.target.value)}
              ...
              <td>
                <input
                  ...
                  value={item.rate}
                  onChange={e => onSetItem(i, 'rate', e.target.value)}
                  placeholder="0.00"
                  style={{ ...inputStyle, textAlign: 'right' }}
                />
              </td>
